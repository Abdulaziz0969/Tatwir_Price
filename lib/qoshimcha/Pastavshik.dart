...
class Pastavshik extends StatefulWidget {
  const Pastavshik({super.key});

  @override
  State<Pastavshik> createState() => _kilentgaSotishValyutasiState();
}

class _kilentgaSotishValyutasiState extends State<Pastavshik> {
  ...
  void priceChanged({isCheckedSomClient = true, isCheckedDollarClient = false, isCheckedAralashClient = false}){
    ...
    narxNazorati.pastavshik.value = _isCheckedsomKilent ? 300 : _isCheckeddollorKilent ? 300 : _isCheckedaralashKilent ? 600 : 0;
    narxNazorati.update();
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  SizedBox(width: 5,),
                  Expanded(child: Text("Pastavchikdan sotib olish valyutasi?",style: TextStyle(fontSize: 20,color: Colors.black,fontFamily: "Rubik"),)),
                ],
              ),
              ...
              Row(
                ...
                children: [
                  SizedBox(width: 15,),
                  Text(
                    "Narx: ${narxNazorati.pastavshik.value}\$",
