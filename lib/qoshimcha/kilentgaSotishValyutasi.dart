...
class kilentgaSotishValyutasi extends StatefulWidget {
  const kilentgaSotishValyutasi({super.key});

  @override
  State<kilentgaSotishValyutasi> createState() => _kilentgaSotishValyutasiState();
}

class _kilentgaSotishValyutasiState extends State<kilentgaSotishValyutasi> {
  ...
  void priceChanged({isCheckedSomClient = true, isCheckedDollarClient = false, isCheckedAralashClient = false}){
    ...
    narxNazorati.klientgaSavdoValyutasi.value = _isCheckedsomKilent ? 300 : _isCheckeddollorKilent ? 300 : _isCheckedaralashKilent ? 600 : 0;
    narxNazorati.update();
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  SizedBox(width: 5,),
                  Text("Kilentga sotish valyutasi ?",style: TextStyle(fontSize: 18,color: Colors.black,fontFamily: "MarkoOne"),),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    ...
                    child: Text(
                      "Som",
                      style: TextStyle(fontSize: 14, color: Colors.black, fontFamily: "MarkoOne"),
                    ),
                  ),
                  SizedBox(width: 10),
                  Expanded(
              ...
              Row(
                ...
                children: [
                  SizedBox(width: 15,),
                  Text(
                    "Narx: ${narxNazorati.klientgaSavdoValyutasi.value}\$",
